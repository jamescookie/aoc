...
class Day7Spec extends Specification {
    ...
    def "part1 tests"() {
        ...
        def combinations = Amplification.findCombinations(phases)

        expect:
        output == Amplification.partOne(combinations, input)
    ...
    def "part1"() {
        ...
        expect:
        Amplification.partOne(combinations, puzzleInput) == 34686
    }

    def "part2 tests"() {
        given:
        def phases = [5, 6, 7, 8, 9]
        def combinations = Amplification.findCombinations(phases)

        expect:
        output == Amplification.partTwo(combinations, input)
    ...
    def "part2"() {
        ...
        expect:
        Amplification.partTwo(combinations, puzzleInput) == 36384144
    }
}