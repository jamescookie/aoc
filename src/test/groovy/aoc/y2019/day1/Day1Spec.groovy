...
class Day1Spec extends Specification {
    ...
    def "part1"() {
        expect:
        puzzleInput.collect{Mass.part1(it)}.sum() == 3515171
    }

    def "part2 tests"() {
        expect:
        Mass.part2(input) == output
    ...
    def "part2"() {
        expect:
        puzzleInput.collect{Mass.part2(it)}.sum() == 5269882
    }
}