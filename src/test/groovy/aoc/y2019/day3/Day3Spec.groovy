...
class Day3Spec extends Specification {
    ...
    def "part1"() {
        expect:
        FindPoints.part1(puzzleInput1, puzzleInput2) == 221
    }

    def "part2 tests"() {
        expect:
        FindPoints.part2(input1, input2) == output
    ...
    def "part2"() {
        expect:
        FindPoints.part2(puzzleInput1, puzzleInput2) == 18542
    }
